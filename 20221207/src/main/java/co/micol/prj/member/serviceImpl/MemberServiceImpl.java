...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public MemberVO productDetail(String productCode) {
		// TODO Auto-generated method stub
		return map.productDetail(productCode);
	}

	@Override
	public List<Map<String, Object>> likeProductList() {
		// TODO Auto-generated method stub
		return map.likeProductList();
	}
